    ...
    commitments.forEach(com => {
      ...
      if (!grouped.has(key)) {
        grouped.set(key, { 
          ...
          legacyMaterialArrivedDate: com.materialArrivedDate,
        ...
        if (com.materialArrivedDate && !existing.legacyMaterialArrivedDate) { existing.legacyMaterialArrivedDate = com.materialArrivedDate; }
